...
class Produto(Base, UUIDPrimaryKey, TimestampMixin):
    ...
    preco_compra: Mapped[Decimal] = mapped_column(Numeric(10, 2), nullable=False, default=0)
    preco_venda: Mapped[Decimal] = mapped_column(Numeric(10, 2), nullable=False, default=0)
    ...
    categoria: Mapped[Categoria | None] = relationship("Categoria", back_populates="produtos")
    fornecedor: Mapped[Fornecedor | None] = relationship("Fornecedor", back_populates="produtos")
